...
import { ItemLitigio } from '../../model/litigio';
...
export class ItensLitigiosApiService extends GenericApi<ItemLitigio> {

  constructor(private http: HttpClient, private arquivosApi: ArquivosApiService) {
    super(http, environment.api + endpoints.itensLitigios);
  }
